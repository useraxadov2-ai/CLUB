...
def replace_emojis_in_text(text: str) -> str:
    """Matndagi barcha ma'lum emojilarni premium teglar bilan almashtiradi."""
...
MENU_SEED_ITEMS = {
    "gazaklar": [
        ("TUC", "tuc"), ("Idish qurt (assorti)", "idish_qurt_assorti"),
        ("Lays 100 gr", "lays_100_gr"), ("Anchous", "anchous"),
        ("Keshyu", "keshyu"), ("Lays 140 gr", "lays_140_gr"),
        ("Araxis", "araxis"), ("Keshyu Ermak 40 gr", "keshyu_ermak_40_gr"),
        ("Lays 225 gr", "lays_225_gr"), ("Araxis Ermak 50 gr", "araxis_ermak_50_gr"),
        ("Kostochki", "kostochki"), ("Lays 70 gr", "lays_70_gr"),
        ("Yong'oq assortisi", "yongoq_assortisi"), ("Qurt 30 gr Zavq", "qurt_30_gr_zavq"),
        ("Pringles 165 gr", "pringles_165_gr"),
        ("Ermak yong'oq assortisi 45 gr", "ermak_yongoq_assortisi_45_gr"),
        ("Qurt Ermak 30 gr", "qurt_ermak_30_gr"), ("Pringles katta", "pringles_katta"),
        ("Bodom", "bodom"), ("Qurt Ermak 60 gr", "qurt_ermak_60_gr"),
        ("Pringles kichik", "pringles_kichik"), ("Grenki", "grenki"),
        ("Qurt Ixlos (assorti)", "qurt_ixlos_assorti"), ("Pistashki", "pistashki"),
        ("Semechki 100 gr", "semechki_100_gr"),
        ("Pistashki Ermak 30 gr", "pistashki_ermak_30_gr"),
        ("Semechki 160 gr", "semechki_160_gr"), ("Flint suxariki", "flint_suxariki"),
        ("Sirniye palochki – Suluguni", "sirniye_palochki_suluguni"),
        ("Sirniye palochki 150", "sirniye_palochki_150"),
        ("Sirniye palochki Big – Suluguni", "sirniye_palochki_big_suluguni"),
        ("Tosh qurt 30 gr Zavq", "tosh_qurt_30_gr_zavq"),
        ("Tosh qurt Ixlos", "tosh_qurt_ixlos")
    ],
    "tamaki": [
        ("Terrea", "terrea"), ("Kalyan bonus", "kalyan_bonus"),
        ("Qo'shimcha ko'mir", "qoshimcha_komir"),
        ("Kola 1 L bonus", "kola_1_l_bonus"),
        ("Qo'shimcha kalyan chashkasi", "qoshimcha_kalyan_chashkasi"),
        ("Kalyan", "kalyan")
    ],
    "suvlar": [
        ("18+", "18_plus"), ("Evian", "evian"),
        ("BonAqua gazsiz 0.5 L", "bonaqua_gazsiz_0_5_l"),
        ("Barbican", "barbican"), ("Gorilla", "gorilla"),
        ("BonAqua gazli 0.5 L", "bonaqua_gazli_0_5_l"),
        ("Blanc Blue", "blanc_blue"), ("Pulpy", "pulpy"),
        ("Borjomi 0.5 L", "borjomi_0_5_l"), ("Chupa Chups", "chupa_chups"),
        ("Red Bull 0.25 L", "red_bull_0_25_l"),
        ("Borjomi limonad", "borjomi_limonad"),
        ("Dovcha Green 0.5 L", "dovcha_green_0_5_l"),
        ("Rich sharbati 1 L", "rich_sharbati_1_l"),
        ("Kapuchino (qahva)", "kapuchino_qahva"),
        ("Dovcha Nok 0.5 L", "dovcha_nok_0_5_l"), ("Royal", "royal"),
        ("Kola 0.25 L", "kola_0_25_l"),
        ("Dovcha Olcha 0.5 L", "dovcha_olcha_0_5_l"),
        ("Schweppes", "schweppes"), ("Kola 0.5 L", "kola_0_5_l"),
        ("Dovcha Xtra 0.33 L", "dovcha_xtra_0_33_l"),
        ("Americano (qahva)", "americano_qahva"),
        ("Latte (qahva)", "latte_qahva"),
        ("Limonad Tsitrus–Marakuya 1 L", "limonad_tsitrus_marakuya_1_l"),
        ("Kola 1 L", "kola_1_l"),
        ("Limonad Mango–Marakuya 0.5 L", "limonad_mango_marakuya_0_5_l"),
        ("Limonad Tarxun 0.5 L", "limonad_tarxun_0_5_l"),
        ("Kola JB 0.5 L", "kola_jb_0_5_l"),
        ("Limonad Mango–Marakuya 1 L", "limonad_mango_marakuya_1_l"),
        ("Limonad Tarxun 1 L", "limonad_tarxun_1_l"),
        ("Kola Zero 0.25 L", "kola_zero_0_25_l"),
        ("Limonad Mojito Klassik 0.5 L", "limonad_mojito_klassik_0_5_l"),
        ("Mojito 0.33 L", "mojito_0_33_l"),
        ("Kola (shisha)", "kola_shisha"),
        ("Limonad Mojito Klassik 1 L", "limonad_mojito_klassik_1_l"),
        ("Mojito 0.5 L", "mojito_0_5_l"),
        ("Laymon Fresh (yashil) 0.5 L", "laymon_fresh_yashil_0_5_l"),
        ("Limonad Mojito Qulupnay 0.5 L", "limonad_mojito_qulupnay_0_5_l"),
        ("Natakhtari", "natakhtari"),
        ("Laymon Fresh Big", "laymon_fresh_big"),
        ("Limonad Mojito Qulupnay 1 L", "limonad_mojito_qulupnay_1_l"),
        ("Rich 0.2 L", "rich_0_2_l"),
        ("Laymon Fresh (shisha)", "laymon_fresh_shisha"),
        ("Limonad Tsitrus–Marakuya 0.5 L", "limonad_tsitrus_marakuya_0_5_l"),
        ("Fanta (shisha)", "fanta_shisha"),
        ("Chortoq 0.5 L", "chortoq_0_5_l"),
        ("Sprite 0.25 L", "sprite_0_25_l"),
        ("Fuze Tea 0.5 L (assorti)", "fuze_tea_0_5_l_assorti"),
        ("Espresso (qahva)", "espresso_qahva"),
        ("Sprite 0.5 L", "sprite_0_5_l"),
        ("Fuze Tea 1 L (assorti)", "fuze_tea_1_l_assorti"),
        ("Sprite 1 L", "sprite_1_l"),
        ("Fuze Tea gazsiz", "fuze_tea_gazsiz"),
        ("Sprite (shisha)", "sprite_shisha"),
        ("Fuze Tea gazsiz 250 ml", "fuze_tea_gazsiz_250_ml"),
        ("Fanta 0.25 L", "fanta_0_25_l"), ("Oddiy choy", "oddiy_choy"),
        ("Fanta 0.5 L", "fanta_0_5_l"), ("Limonli choy", "limonli_choy"),
        ("Fanta 1 L", "fanta_1_l"),
        ("Chernogolovka (shisha)", "chernogolovka_shisha")
    ],
    "choylar": [
        ("Qo'shimcha limon", "qoshimcha_limon"),
        ("Rezavor ta'mi", "rezavor_tami"),
        ("Qo'shimcha shakar", "qoshimcha_shakar"),
        ("Haqiqiy Jentelmen choyi", "haqiqiy_jentelmen_choyi"),
        ("Sokin huzur", "sokin_huzur"), ("Tropik ta'm", "tropik_tam"),
        ("Sitrus zarbasi", "sitrus_zarbasi"),
        ("Yaseminli choy", "yaseminli_choy"),
        ("Earl Grey Cream choyi", "earl_grey_cream_choyi")
    ],
    "shirinliklar": [
        ("7 Days", "7_days"), ("KitKat Mini", "kitkat_mini"),
        ("Millenium Air", "millenium_air"),
        ("Alpen Gold Max & Fun", "alpen_gold_max_fun"),
        ("M&M's (sariq)", "m_and_ms_sariq"),
        ("Millenium Gold", "millenium_gold"),
        ("Biscolata Stix", "biscolata_stix"),
        ("M&M's (qora)", "m_and_ms_qora"),
        ("Oreo", "oreo"), ("Biscolata pechenye", "biscolata_pechenye"),
        ("Mars", "mars"), ("Oreo Big", "oreo_big"), ("Bounty", "bounty"),
        ("Merci (plitka)", "merci_plitka"), ("Picnic", "picnic"),
        ("Choco Pie Big", "choco_pie_big"),
        ("Milka Brownie", "milka_brownie"),
        ("Ritter Sport", "ritter_sport"),
        ("Choco Pie Mini", "choco_pie_mini"),
        ("Milka pechenye", "milka_pechenye"), ("Skittles", "skittles"),
        ("Florida pechenye", "florida_pechenye"),
        ("Milka (plitka)", "milka_plitka"),
        ("Kinder shokolad Mini", "kinder_shokolad_mini"),
        ("Xottabich Premium", "xottabich_premium"),
        ("Snickers", "snickers"),
        ("Qahva va choy pechenyesi", "qahva_va_choy_pechenyesi"),
        ("Snickers Big (o'rmon yong'oqli)", "snickers_big_ormon_yongoqli"),
        ("Mamba", "mamba"), ("Twix", "twix"),
        ("Marmelad", "marmelad"), ("Barni", "barni"),
        ("Shirin yong'oqchalar", "shirin_yongoqchalar"),
        ("Kinder Bueno", "kinder_bueno"),
        ("Pistali yong'oqchalar", "pistali_yongoqchalar"),
        ("Kinder Delice", "kinder_delice"),
        ("Mevali assorti", "mevali_assorti"),
        ("Kinder shokolad", "kinder_shokolad"),
        ("Xottabich", "xottabich")
    ]
}
...
async def seed_database():
    ...
    if menu_data is None or menu_data == {} or not any(menu_data.values()):
        ...
        logging.info("✅ Menyu bazaga yozildi (narxlar va rasmlar bo'sh!)")
...
try:
    ...
    types = None
    ai_client = None
    logging.warning("⚠️ google-genai kutubxonasi topilmadi, AI yordamchi ishlamaydi!")
...
def main_menu():
    ...
    builder.row(InlineKeyboardButton(
        text="AI Yordamchi", callback_data="ai_start",
        icon_custom_emoji_id=EMOJI_IDS.get("🤖")))
    builder.row(
        InlineKeyboardButton(
            text="Xonalar va Narxlar", callback_data="rooms_prices",
            icon_custom_emoji_id=EMOJI_IDS.get("🏘")),
        InlineKeyboardButton(
            text="Bo'sh Joylar", callback_data="empty_places",
            icon_custom_emoji_id=EMOJI_IDS.get("📂")))
    builder.row(
        InlineKeyboardButton(
            text="Joy Bron Qilish", callback_data="booking",
            icon_custom_emoji_id=EMOJI_IDS.get("📅")),
        InlineKeyboardButton(
            text="Tez-kor Bron", callback_data="quick_booking",
    ...
    builder.row(
        InlineKeyboardButton(
            ...
            icon_custom_emoji_id=EMOJI_IDS.get("📍")),
        InlineKeyboardButton(
            text="Bonuslar va Chegirmalar", callback_data="bonuses",
            icon_custom_emoji_id=EMOJI_IDS.get("💎")))
    builder.row(
        InlineKeyboardButton(
...
def select_room(cabin_type, rooms):
    ...
    builder.row(
        InlineKeyboardButton(
            text="⬅️ Orqaga", callback_data="back_rooms",
            icon_custom_emoji_id=EMOJI_IDS.get("⬅️")),
        InlineKeyboardButton(
...
def menu_categories():
    ...
    builder.row(
        InlineKeyboardButton(text="Gazaklar", callback_data="menu_gazaklar",
                             icon_custom_emoji_id=EMOJI_IDS.get("😎1")),
...
def menu_items_buttons(category_key, items: dict):
    ...
    for item_id, item in entries:
        ...
        row.append(InlineKeyboardButton(
            text=btn_text,
            callback_data=f"item::{category_key}::{item_id}",
...
def item_detail_keyboard(category_key, item_id):
    ...
    builder.row(InlineKeyboardButton(
        text="⬅️ Orqaga", callback_data=f"menu_{category_key}",
        icon_custom_emoji_id=EMOJI_IDS.get("⬅️")))
    builder.row(InlineKeyboardButton(
        text="🏘 Bosh Menyu", callback_data="main_menu",
        icon_custom_emoji_id=EMOJI_IDS.get("🏘")))
...
def admin_main_menu():
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(
        text="🏘 Kabinalarni tahrirlash", callback_data="adm_cabins",
        icon_custom_emoji_id=EMOJI_IDS.get("🏘")))
    builder.row(InlineKeyboardButton(
    ...
    builder.row(InlineKeyboardButton(
        ...
        icon_custom_emoji_id=EMOJI_IDS.get("🍴")))
    builder.row(InlineKeyboardButton(
        text="📝 Matnlarni tahrirlash", callback_data="adm_texts",
        icon_custom_emoji_id=EMOJI_IDS.get("📝")))
    return builder.as_markup()
...
def admin_cabin_detail_keyboard(cabin_key):
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(
        text="✏️ Narxi", callback_data=f"admcabfield::{cabin_key}::price"))
    builder.row(InlineKeyboardButton(
        text="✏️ Sig'imi", callback_data=f"admcabfield::{cabin_key}::capacity"))
    builder.row(InlineKeyboardButton(
        text="✏️ Jihozlari", callback_data=f"admcabfield::{cabin_key}::equipment"))
    builder.row(InlineKeyboardButton(
        text="🖼 Rasmi (link)",
        callback_data=f"admcabfield::{cabin_key}::image",
        icon_custom_emoji_id=EMOJI_IDS.get("🖼")))
    builder.row(InlineKeyboardButton(
        text="⬅️ Orqaga", callback_data="adm_cabins",
        icon_custom_emoji_id=EMOJI_IDS.get("⬅️")))
    return builder.as_markup()
...
def admin_menu_item_keyboard(category_key, item_id):
    ...
    builder.row(InlineKeyboardButton(
        text="✏️ Nomi",
        callback_data=f"admitemfield::{category_key}::{item_id}::name"))
    builder.row(InlineKeyboardButton(
        text="✏️ Narxi",
        callback_data=f"admitemfield::{category_key}::{item_id}::price"))
    builder.row(InlineKeyboardButton(
        text="🖼 Rasmi (link)",
...
async def send_product_card(message: Message, category_key: str, item_id: str, item: dict):
    ...
    if image and image.startswith("http"):
        ...
        sent = await message.answer_photo(
            photo=photo_source, caption=text,
...
async def ai_start(callback: CallbackQuery, state: FSMContext):
    ...
    if ai_client is None:
        await safe_edit(callback, text="🤖 AI yordamchi hozircha sozlanmagan.",
    ...
    try:
        greeting_resp = await ai_client.aio.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                system_instruction=AI_SYSTEM_PROMPT, temperature=0.8))
...
async def ai_chat(message: Message, state: FSMContext):
    ...
    resp = None
    parsed = {"type": "chat", "text": "Kechirasiz, hozir javob bera olmadim."}
    try:
    ...
    if msg_type == "product_search":
        ...
        if item:
            ...
            await message.answer(parsed.get("text") or f'Kechirasiz, "{query}" topilmadi 😔')
    else:
    ...
    if image and image.startswith("http"):
        try:
            ...
            sent = await callback.message.answer_photo(
                photo=photo_source, caption=replace_emojis_in_text(text),
                reply_markup=cabin_detail_action_keyboard(cabin_key))
            if cache_key not in FILE_ID_CACHE and sent.photo:
                FILE_ID_CACHE[cache_key] = sent.photo[-1].file_id
        except Exception:
            logging.exception("Kabina rasmini yuborishda xatolik: %s", image)
            FILE_ID_CACHE.pop(cache_key, None)
            await callback.message.answer(replace_emojis_in_text(text),
                                          reply_markup=cabin_detail_action_keyboard(cabin_key))
    else:
        await safe_edit(callback, text=text,
                        reply_markup=cabin_detail_action_keyboard(cabin_key))
...
async def action_book_from_detail(callback: CallbackQuery, state: FSMContext):
    ...
    await safe_edit(callback, text=text,
                    reply_markup=select_room(cabin_key, cabin.get("rooms", [])))
...
async def confirm_booking(message: Message, state: FSMContext):
    ...
    try:
        await fb_push("orders", {
            "type": "cabin_booking", "user_id": user.id,
            "cabin": data["cabin"], "room": data["room"], "time": message.text})
    except Exception:
...
async def quick_booking(callback: CallbackQuery, state: FSMContext):
    ...
    await safe_edit(callback, text="⚡ <b>Tez-kor Bron</b>\n\nQaysi turdagi xonani bron qilmoqchisiz?",
                    reply_markup=cabin_types("quick"))
...
async def confirm_quick_booking(message: Message, state: FSMContext):
    ...
    try:
        await fb_push("orders", {"type": "quick_booking", "user_id": user.id,
                                 "cabin": data["cabin"], "time": message.text})
    except Exception:
...
async def start_menu_order(callback: CallbackQuery, state: FSMContext):
    ...
    await state.update_data(order_item=item_name, order_category=category_key,
...
async def relay_admin_reply_to_user(message: Message):
    ...
    try:
        ...
        await message.reply("⚠️ Javobni yuborib bo'lmadi.")
...
async def admin_cabins(callback: CallbackQuery):
    if not is_admin(callback.from_user.id):
        ...
        return
    await callback.answer()
    await safe_edit(callback, text="🏠 <b>Kabinani tanlang</b>",
                    reply_markup=cabin_types("admcab"))
...
async def admin_cabin_detail(callback: CallbackQuery):
    ...
    cabin = await fb_get(f"cabins/{cabin_key}") or {}
    text = (f"🏠 <b>{cabin.get('name', cabin_key)}</b>\n\n"
            f"💰 Narx: {cabin.get('price', '-')}\n"
            f"👥 Sig'im: {cabin.get('capacity', '-')}\n"
            f"🎮 Jihozlar: {cabin.get('equipment', '-')}\n\n"
            "O'zgartirmoqchi bo'lgan maydonni tanlang:")
    await safe_edit(callback, text=text,
                    reply_markup=admin_cabin_detail_keyboard(cabin_key))
...
async def admin_cabin_field(callback: CallbackQuery, state: FSMContext):
    ...
    field_names = {"price": "narx", "capacity": "sig'im",
                   "equipment": "jihozlar", "image": "rasm linki"}
...
async def admin_rooms(callback: CallbackQuery):
    ...
    await callback.answer()
    await safe_edit(callback, text="🚪 <b>Kabinani tanlang</b>",
                    reply_markup=cabin_types("admroomcab"))
...
async def _render_admin_rooms(callback: CallbackQuery, cabin_key: str):
    ...
    for room, status in sorted(statuses.items()):
        ...
        builder.row(InlineKeyboardButton(
            text=f"{emoji} #{room} — {status} (bosib almashtiring)",
            callback_data=f"admtoggle::{cabin_key}::{room}"))
    builder.row(InlineKeyboardButton(text="⬅️ Orqaga", callback_data="adm_rooms"))
    await safe_edit(callback, text=f"🚪 <b>{cabin.get('name', cabin_key)} — Xonalar</b>",
...
async def admin_menu_category_items(callback: CallbackQuery):
    ...
    for item_id, item in sorted(items.items(), key=lambda kv: (kv[1] or {}).get("name", "")):
        ...
        builder.row(InlineKeyboardButton(
            text=f"{name} ({price})",
            callback_data=f"admmenuitem::{category_key}::{item_id}"))
    builder.row(InlineKeyboardButton(
        text="➕ Yangi mahsulot qo'shish", callback_data=f"admmenuadd::{category_key}"))
    builder.row(InlineKeyboardButton(text="⬅️ Orqaga", callback_data="adm_menu"))
    await safe_edit(callback,
                    text=f"📋 <b>{CATEGORY_NAMES.get(category_key, category_key)}</b>",
                    reply_markup=builder.as_markup())
...
async def admin_menu_item_detail(callback: CallbackQuery):
    ...
    await safe_edit(callback, text=text,
                    reply_markup=admin_menu_item_keyboard(category_key, item_id))
...
async def admin_item_set_value(message: Message, state: FSMContext):
    if not is_admin(message.from_user.id):
        return
    data = await state.get_data()
    await fb_update(f"menu/{data['category_key']}/{data['item_id']}",
...
async def admin_item_delete_confirm(callback: CallbackQuery):
    ...
    builder.row(InlineKeyboardButton(
        text="✅ Ha, o'chirish",
        callback_data=f"admitemdelyes::{category_key}::{item_id}"))
    builder.row(InlineKeyboardButton(
        text="⬅️ Bekor qilish",
        callback_data=f"admmenuitem::{category_key}::{item_id}"))
    await safe_edit(callback, text="⚠️ Haqiqatan ham o'chirmoqchimisiz?",
                    reply_markup=builder.as_markup())
...
async def admin_menu_add_image(message: Message, state: FSMContext):
    ...
    await fb_set(f"menu/{category_key}/{item_id}",
                 {"name": name, "price": price, "image": image})
    await message.answer(f"✅ \"{name}\" mahsuloti qo'shildi!",
                         reply_markup=admin_main_menu())
    await state.clear()


# ---- Matnlarni tahrirlash ----
TEXT_KEYS = {"bonuses": "🎁 Bonuslar", "news": "📰 Yangiliklar",
             "tournaments": "🏆 Turnirlar", "contact": "📍 Aloqa"}
...
async def admin_texts(callback: CallbackQuery):
    ...
    builder.row(InlineKeyboardButton(text="⬅️ Orqaga", callback_data="adm_main"))
    await safe_edit(callback, text="📝 <b>Qaysi matnni tahrirlaymiz?</b>",
                    reply_markup=builder.as_markup())
...
async def admin_text_edit_start(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.answer(
        f"✏️ '{TEXT_KEYS.get(key, key)}' uchun yangi matnni yuboring (HTML formatlash mumkin):")
